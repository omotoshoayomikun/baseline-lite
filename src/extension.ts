...
export function activate(context: vscode.ExtensionContext) {
  ...
  function run(doc?: vscode.TextDocument) {
    ...
    const presentation = (vscode.workspace.getConfiguration('baselineLinter').get('presentation') as 'diagnostic'|'decorations'|'both') ?? 'diagnostic';
  ...
  context.subscriptions.push(
    ...
    vscode.workspace.onDidChangeConfiguration(e => { if (e.affectsConfiguration('baselineLinter')) run(); }),
